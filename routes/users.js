...
router.get("/", ensureValidUserOrAdmin, async function (req, res, next) {
  try {
...
router.get("/:username", ensureValidUserOrAdmin, async function (req, res, next) {
  try {
...
router.patch("/:username", ensureValidUserOrAdmin, async function (req, res, next) {
  try {
...
router.delete("/:username", ensureValidUserOrAdmin, async function (req, res, next) {
  try {
